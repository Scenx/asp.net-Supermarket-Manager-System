...
<%@ Register TagPrefix="uc1" TagName="EmployeeHeadmodule" Src="../UserControl/EmployeeHeadmodule.ascx" %>
						...
						<td>
							...
							<table class="tbl" id="Table2" cellSpacing="0" cellPadding="0" width="760" border="0">
								<tr>
									<td>
										<!--   导航超链接   -->
											<uc1:EmployeeHeadmodule id="EmployeeHeadmodule" runat="server"></uc1:EmployeeHeadmodule>
										<!--   /导航主菜单   --></td>
								</tr>
								<tr>
									<td align="center"></td>
