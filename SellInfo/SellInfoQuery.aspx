<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellInfoQuery.aspx.cs" Inherits="SellInfo_SellInfoQuery" %>
...
<body>
	  ...
	  <td style="height: 14px; width: 605px;">
        ...
        <tr>
          <td style="height: 37px; width: 605px;">
              ...
              单据号:<asp:TextBox ID="SellNo" runat="server" Width="140px"></asp:TextBox><br />
       ...
       <asp:Button ID="Btn_Query" runat="server" OnClick="Btn_Query_Click"
            Text="查询" /><br />
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                  ...
                  <Columns>
                      <asp:BoundField DataField="sellNo" HeaderText="单据号" ReadOnly="true" SortExpression="sellNo" />
                      ...
                      <asp:BoundField DataField="price" HeaderText="销售价格" SortExpression="price" />
                      <asp:BoundField DataField="number" HeaderText="销售数量" SortExpression="price" />
                      <asp:BoundField DataField="sellTime" HeaderText="销售时间" SortExpression="sellTime" />
    ...
    <td align=right style="height: 12px">
        当前查询条件下销售总金额为：<asp:Label ID="TotalPrice" runat="server" Text="Label"></asp:Label>元</td></tr>
    </table>
  </form>
</body>
</html>
