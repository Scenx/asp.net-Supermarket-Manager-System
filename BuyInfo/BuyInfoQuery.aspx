...
<body>
   ...
   <asp:SqlDataSource ID="BuyInfoDataSource" runat="server" ConnectionString="Data Source=.;Initial Catalog=supermarketdb;uid=renzhenhua;pwd=123456"
                  SelectCommand="SELECT * from [buyInfo]" ProviderName="System.Data.SqlClient">
              </asp:SqlDataSource>
</body>
</html>
